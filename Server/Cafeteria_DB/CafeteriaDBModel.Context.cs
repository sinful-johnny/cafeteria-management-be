...
namespace Cafeteria_DB
{
    ...
    public partial class cafeteria_DBEntities : DbContext
    {
        public cafeteria_DBEntities()
            : base("name=cafeteria_DBEntities")
        {
        }
        ...
        public virtual ObjectResult<GetAllShapeTypes_Result> GetAllShapeTypes()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAllShapeTypes_Result>("GetAllShapeTypes");
        }
        ...
        public virtual int sp_ADMIN_DELETETABLE(string iD_TABLE, ObjectParameter responseMessage)
        {
            var iD_TABLEParameter = iD_TABLE != null ?
                new ObjectParameter("ID_TABLE", iD_TABLE) :
                new ObjectParameter("ID_TABLE", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_ADMIN_DELETETABLE", iD_TABLEParameter, responseMessage);
        }
        ...
        public virtual int sp_ADMIN_UPDATETABLE(string iD_TABLE, Nullable<double> x_COORDINATE, Nullable<double> y_COORDINATE, ObjectParameter responseMessage)
        {
            var iD_TABLEParameter = iD_TABLE != null ?
                new ObjectParameter("ID_TABLE", iD_TABLE) :
                new ObjectParameter("ID_TABLE", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_ADMIN_UPDATETABLE", iD_TABLEParameter, x_COORDINATEParameter, y_COORDINATEParameter, responseMessage);
        }
